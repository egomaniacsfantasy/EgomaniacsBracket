...
The predictor uses DayNum=121 (current regular-season context, ~Mar 4 2026) for all predictions.
...
DAYNUM = 121  # Current regular-season context (~Mar 4 2026; update each season)
...
// DayNum={DAYNUM} (regular-season context), 3 location variants per pair (neutral / team-i home / team-j home)
