...
export const NCAA_KNOWN_RESULTS: LockedPicks = {
  ...
  "East-R32-1": "East-5", // St John's (5) def Kansas (4)
  "East-R32-2": "East-3", // Michigan St (3) def Louisville (6)
  "East-R32-3": "East-2", // Connecticut (2) def UCLA (7)
  ...
  "South-R32-0": "South-9", // Iowa (9) def Florida (1)
  ...
  "South-E8-0": "South-3", // Illinois (3) def Iowa (9)
  ...
  "Midwest-R64-4": "Midwest-6", // Tennessee (6) def Miami OH (11)
  ...
  "Midwest-R32-0": "Midwest-1", // Michigan (1) def St Louis (9)
  "Midwest-R32-1": "Midwest-4", // Alabama (4) def Texas Tech (5)
  "Midwest-R32-2": "Midwest-6", // Tennessee (6) def Virginia (3)
  "Midwest-R32-3": "Midwest-2", // Iowa St (2) def Kentucky (7)
  "West-R64-0": "West-1", // Arizona (1) def LIU Brooklyn (16)
  "West-R64-1": "West-9", // Utah St (9) def Villanova (8)
  ...
  "West-R32-0": "West-1", // Arizona (1) def Utah St (9)
  "West-R32-1": "West-4", // Arkansas (4) def High Point (12)
  "West-R32-2": "West-11b", // Texas (11) def Gonzaga (3)
  "West-R32-3": "West-2", // Purdue (2) def Miami FL (7)
  "South-S16-0": "South-9", // Iowa (9) def Nebraska (4)
