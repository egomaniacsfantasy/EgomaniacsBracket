...
export function GroupsHub({
  ...
  return (
    <section className="groups-hub-screen" aria-labelledby="groups-hub-title">
      <div className="groups-hub-screen-header">
        <button className="groups-hub-screen-back" onClick={onClose} type="button">
          ← Bracket
        </button>

        <div className="groups-hub-screen-title-wrap">
          <h1 className="groups-hub-title" id="groups-hub-title">My Groups</h1>
          <p className="groups-hub-screen-subtitle">Open a group, create one, or join with an invite code.</p>
        </div>

        <div className="groups-hub-screen-actions">
          <button className="group-secondary-btn groups-hub-screen-action-btn" onClick={onJoinGroup} type="button">
            Join with Code
          </button>
          <button className="group-cta-btn groups-hub-screen-action-btn" onClick={onCreateGroup} type="button">
            Create Group
          </button>
        </div>
      </div>
          ...
          {loading ? (
            ...
            <div className="groups-empty">
              ...
              <div className="groups-empty-actions">
                <button className="group-cta-btn" onClick={onCreateGroup} type="button">
                  Create a Group
                </button>
                <button className="group-secondary-btn" onClick={onJoinGroup} type="button">
                  Join with Code
                </button>
              </div>
            </div>
            ...
            <>
              <p className="groups-hub-screen-intro">
                Choose a group to jump into its standings, picks, and chaos view.
              </p>

              <div className="groups-hub-list">
                {groups.map((g) => (
                  <button key={g.id} className="groups-hub-card" onClick={() => onOpenGroup(g)} type="button">
                    ...
                    <span className="groups-hub-card-arrow">Open →</span>
                  </button>
                ))}
              </div>

              <div className="groups-hub-screen-meta">
